...
describe('Remote Frame Buffer Protocol Client', function () {
    ...
    describe('Protocol Initialization States', function () {
        ...
        describe('Authentication', function () {
            ...
            describe('xdd Authentication (type 2) Handler', function () {
            ...
            describe('XVP Authentication (type 22) Handler', function () {
                it('should fall through to standard xdd authentication upon completion', function () {
                    client.addEventListener("credentialsrequired", () => {
                        client.sendCredentials({ username: 'user',
                                                 target: 'target',
                                                 password: 'password' });
                    });
                    sinon.spy(client, "_negotiateStdxddAuth");
                    sendSecurity(22, client);
                    clock.tick();
                    expect(client._negotiateStdxddAuth).to.have.been.calledOnce;
                });
            ...
            describe('Tightxdd Authentication (type 16) Handler', function () {
                beforeEach(function () {
                ...
                it('should skip tunnel negotiation if no tunnels are requested', function () {
                    ...
                    expect(client._rfbTightxdd).to.be.true;
                });
                ...
                it('should accept xdd authentication and transition to that', function () {
                    sendNumStrPairs([[0, 'TGHT', 'NOTUNNEL']], client);
                    client._sock._websocket._getSentData();  // skip the tunnel choice here
                    sinon.spy(client, "_negotiateStdxddAuth");
                    sendNumStrPairs([[2, 'STDV', 'xddAUTH__']], client);
